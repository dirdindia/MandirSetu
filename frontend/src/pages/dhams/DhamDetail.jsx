  ...
  if (!dham) {
    return (
      <div className="min-h-screen pt-24 flex flex-col justify-center items-center bg-[#fdfbf7]">
        <h2 className="text-3xl font-serif text-[#791916] mb-4">Dham Not Found</h2>
        <Link to="/dhams" className="text-[#d4af37] font-semibold hover:text-[#791916] transition-colors">Go back to all Dhams</Link>
      </div>
    );
  }
    ...
    <div className="bg-[#fdfbf7] min-h-screen text-[#3a0d0a] font-sans pb-20">
      ...
      <section className="relative h-[85vh] min-h-[700px] flex flex-col justify-center items-center pt-16">
        ...
        <div className="relative z-20 flex flex-col items-center text-center px-4 w-full max-w-5xl mt-[-40px]">
          <h2 className="text-[#d4af37] text-lg sm:text-xl md:text-2xl font-serif tracking-widest mb-4">॥ जय श्री {dham.mainDeity || 'राम'} ॥</h2>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl shadow-[#791916]/10 border border-[#d4af37]/20 flex items-center gap-4 hover:-translate-y-1 transition-transform">
              ...
              <div>
                ...
                <p className="text-sm text-[#791916]/70 leading-tight mt-1">{dham.mainDeity || 'N/A'}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl shadow-[#791916]/10 border border-[#d4af37]/20 flex items-center gap-4 hover:-translate-y-1 transition-transform">
              ...
              <div>
                ...
                <p className="text-sm text-[#791916]/70 leading-tight mt-1 truncate">{dham.location?.city}, {dham.location?.state}</p>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
               <img src={dham.profilePic || `https://ui-avatars.com/api/?name=${encodeURIComponent(dham.name)}&background=791916&color=d4af37&size=1024`} alt={dham.name} className="w-full h-[500px] object-cover rounded-3xl shadow-2xl border border-[#d4af37]/20" />
            ...
            <div>
               <h2 className="text-3xl sm:text-5xl font-serif text-[#791916] mb-6 uppercase tracking-wider">{dham.name} KA DIVYA DHAM</h2>
               ...
               <div className="grid grid-cols-2 gap-6 pt-6 border-t border-[#d4af37]/30">
                 <div>
                   ...
                   <p className="text-xl font-serif text-[#791916]">{dham.establishedYear || 'Ancient'}</p>
                 </div>
                 <div>
                   <h4 className="text-sm uppercase tracking-widest text-[#791916]/60 font-bold mb-1">Status</h4>
                   <p className="text-xl font-serif text-[#791916] capitalize">{dham.status || 'Active'}</p>
                 </div>
               </div>
            </div>
         </div>
               ...
               <ul className="space-y-6 text-[#3a0d0a]/80">
                 {dham.howToReach?.air ? (
                   <li className="flex items-start gap-4">
                     ...
                     <div><h4 className="font-bold text-[#791916] mb-1">By Air</h4><p>{dham.howToReach.air}</p></div>
                   </li>
                 ) : null}
                 {dham.howToReach?.train ? (
                   <li className="flex items-start gap-4">
                     <span className="text-2xl p-3 bg-[#fdfbf7] rounded-full text-[#791916] border border-[#d4af37]/20">🚆</span>
                     <div><h4 className="font-bold text-[#791916] mb-1">By Train</h4><p>{dham.howToReach.train}</p></div>
                   </li>
                 ) : null}
                 {dham.howToReach?.bus ? (
                   <li className="flex items-start gap-4">
                     <span className="text-2xl p-3 bg-[#fdfbf7] rounded-full text-[#791916] border border-[#d4af37]/20">🚌</span>
                     <div><h4 className="font-bold text-[#791916] mb-1">By Road</h4><p>{dham.howToReach.bus}</p></div>
                   </li>
                 ) : null}
               </ul>
             </div>
             ...
             <div className="relative z-10">
               ...
               <ul className="space-y-6 text-[#fdfbf7]/90">
                 ...
                 {dham.contact?.website ? (
                   <li className="flex items-center gap-4">
                     <span className="text-2xl p-3 bg-black/20 rounded-full text-[#d4af37] border border-[#d4af37]/20">🌐</span>
                     <a href={dham.contact.website} target="_blank" rel="noreferrer" className="text-lg text-[#d4af37] hover:underline">Visit Official Website</a>
                   </li>
                 ) : null}
               </ul>
             </div>
